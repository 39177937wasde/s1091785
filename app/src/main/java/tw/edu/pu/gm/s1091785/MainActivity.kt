...
class MainActivity : AppCompatActivity(), GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, View.OnTouchListener{
    ...
    fun ShowPicture() {
        ...
        /*when (PictureNo) {
            0 -> img.setImageResource(R.drawable.daniel0)
            1 -> img.setImageResource(R.drawable.daniel1)
            2 -> img.setImageResource(R.drawable.daniel2)
            3 -> img.setImageResource(R.drawable.daniel3)
            4 -> img.setImageResource(R.drawable.daniel4)
            5 -> img.setImageResource(R.drawable.daniel5)
        }*/

        txv.text = PictureNo.toString()
        var res:Int = getResources().getIdentifier("daniel" + PictureNo.toString(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        while (res != 0) {
            countDrawables++;
            res = getResources().getIdentifier("daniel" + countDrawables.toString(),
                "drawable", getPackageName());
        }
